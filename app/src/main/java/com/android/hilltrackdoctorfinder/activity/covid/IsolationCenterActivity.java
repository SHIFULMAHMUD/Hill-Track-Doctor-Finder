...
public class IsolationCenterActivity extends FragmentActivity implements OnMapReadyCallback , View.OnClickListener{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(IsolationCenterActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(IsolationCenterActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Intent intent=new Intent(IsolationCenterActivity.this,IsolationCenterDetailsActivity.class);
    ...
    public void getNearestCenterData() {
        ...
        Call<List<Center>> call = apiInterface.getNearestIsolationCenter();
