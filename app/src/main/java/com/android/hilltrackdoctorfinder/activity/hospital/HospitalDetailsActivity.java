...
public class HospitalDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    @BindView(R.id.back)
    ImageButton back;
    String id,hospital_id,distance;
    ...
    private void getHospitalInfo(String id) {
        loading.start();
        apiInterface = ApiClient.getClient().create(ApiInterface.class);
        Call<List<Hospital>> call = apiInterface.getHospitalInfo(id);
    ...
    private boolean appInstalledorNot(String path) {
        PackageManager packageManager = HospitalDetailsActivity.this.getPackageManager();
        boolean appsInstall;
        try {
    ...
    public void onClick(View view) {
        if (view==back){
            ...
            if (installed) {
                ...
                Tools.setErrorToast(HospitalDetailsActivity.this, "WhatsApp Not Installed");
