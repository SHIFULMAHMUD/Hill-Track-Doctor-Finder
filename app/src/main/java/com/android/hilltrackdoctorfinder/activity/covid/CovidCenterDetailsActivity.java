...
public class CovidCenterDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getCenterInfo(String id) {
        ...
        Call<List<Center>> call = apiInterface.getCovidCenterInfo(id);
    ...
    private boolean appInstalledorNot(String path) {
        PackageManager packageManager = CovidCenterDetailsActivity.this.getPackageManager();
        boolean appsInstall;
        try {
    ...
    public void onClick(View view) {
        if (view==back){
            ...
            if (installed) {
                ...
                Tools.setErrorToast(CovidCenterDetailsActivity.this, "WhatsApp Not Installed");
